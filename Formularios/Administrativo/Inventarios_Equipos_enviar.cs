...
{
    public partial class Inventarios_Equipos_enviar : Form
    {
        private Conexion_db_Mysql db_conn;
        private Equipos_Instalacion_Instituciones equipos;
        private TelegramNotifyEquipos telegram_equipos;
        public Inventarios_Equipos_enviar()
        {
            InitializeComponent();
            db_conn = Conexion_db_Mysql.Get_Instance;
            db_conn.Verificar_Conexion();
            telegram_equipos = new TelegramNotifyEquipos();
            orden_trabajo.Text = db_conn.get_num_acciones("orden_trabajo").ToString("D7");
        ...
        {
            Equipos_Instalacion_Instituciones equipos = new Equipos_Instalacion_Instituciones();
        ...
        {
            verificar_instalaciones verify = new verificar_instalaciones();
            verify.Show();
        }
