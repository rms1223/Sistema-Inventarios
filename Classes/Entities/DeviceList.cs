...
namespace SystemIventory.Classes.Entities
{
    class DeviceList : Institution
    {
        ...
        public DeviceList(string lista, string codigo,string institucion, string total_maquinas, string total_paquetes, string modalidad, string tipo, string equipo, string cartel)
